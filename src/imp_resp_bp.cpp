...
imp_resp_bp::imp_resp_bp() :
	imp_resp_fshift() {}

imp_resp_bp::imp_resp_bp(double samplerate,
...
std::vector<double> imp_resp_bp::Get_Causal_Imp_Resp(double freq_center,
